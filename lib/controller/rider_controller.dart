...
import 'package:warda/data/model/response/rider_model.dart';
import 'package:warda/data/model/response/trip_model.dart';
...
import 'package:warda/helper/rider_type.dart';
    ...
    if(response.statusCode == 200) {
      ...
      if(placeDetails.status == 'OK') {
        ...
        ZoneResponseModel response0 = await Get.find<LocationController>().getZone(
          //address0.latitude, address0.longitude, 
          false);
