...
import 'package:warda/data/model/body/delivery_man_body.dart';
import 'package:warda/data/model/body/store_body.dart';
...
class AuthRepo {
  ...
  Future<Response> login({String? username, String? password}) async {
    return await apiClient.postData(
        AppConstants.loginUri, {"user_name": username, "password": password});
  }
  ...
  bool isLoggedIn() {
    print(
        'token::: isLogged in ${sharedPreferences.containsKey(AppConstants.token)}');
    return sharedPreferences.containsKey(AppConstants.token);
  }

  bool clearSharedData() {
    print('hello spash:: clear cashe colled ');
    if (!GetPlatform.isWeb) {
