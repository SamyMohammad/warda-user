...
import 'package:warda/data/model/response/place_details_model.dart';
import 'package:warda/data/model/response/prediction_model.dart';
...
import 'package:warda/view/base/custom_loader.dart';
...
class LocationController extends GetxController implements GetxService {
  ...
  Future<AddressModel> getCurrentLocation(bool fromAddress,
    ...
    ZoneResponseModel responseModel = await getZone(true);
  ...
  Future<ZoneResponseModel> getZone(bool markerLoad,
  ...
  void _setZoneData(AddressModel address, bool fromSignUp, String? route,
    ...
    Get.find<LocationController>().getZone(false).then((response) async {
